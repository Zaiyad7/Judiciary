...
public HashMap<String,Judiciary> lawReport = new HashMap<>();
    ...
    public static void main(String[] args) throws  InterruptedException {
        ...
        for (int i = 1; i<326; i++) {
            ...
            String url = "https://www.judiciary.uk/judgments/page/" + pageNum;
    ...
    private static void crawl(int level,String url, ArrayList<String> visited) throws InterruptedException {
        if(level <=10) {
...
//                System.out.println(doc.title());
                ...
                String caseCourt = pageCourt.text();
                String courtMatch = courtCheck.text();
                String caseDate = pageDate.text();
                String caseData1 = page.text();


                    // Court Name Matching v2 //

//                String [] arrOfCourt = courtMatch.split(" ", 0);
...
//                Pattern ptC = Pattern.compile("(.*)(Court|COURT)");
//                Matcher mtC = ptC.matcher(caseCourt);
//                boolean mtCFound = mtC.find();
//                if (mtCFound) {
...
//                }
                ...
                if (!doc.title().contains(titleCheck)) {
                    ...
                    Matcher mtJ = ptJ.matcher(caseData1);
                    boolean mtJFound = mtJ.find();
                    if (mtJFound) {
                        System.out.println(mtJ.group(1));
                    } else {
                        System.out.println(caseData1);
                    }
                }
